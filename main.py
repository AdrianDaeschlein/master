...
def main():
    ...
    time_1_or_samples_0 = int(input("Do you want to record for a fixed time(3s) (1) or fixed number of samples(400)(0)?: "))
    ...
    if choice == "1":
        ...
        for i in range(int(n)):
            ...
            dr.record_csv(LED, n=1, time_1_or_samples_0=time_1_or_samples_0, samples=400, duration=3)
        ...
        dr.record_csv(LED, n=n, time_1_or_samples_0=time_1_or_samples_0, samples=400, duration=3)
